...
BEGIN
    ...
    -- Variável auxiliar para identificar quando muda de cliente
    SET @ultimoCliente = NULL;

    -- Cursor: percorre os pedidos ordenados por cliente e data
...
END IF;
        ...
        IF @ultimoCliente IS NULL OR v_idCliente <> @ultimoCliente THEN
